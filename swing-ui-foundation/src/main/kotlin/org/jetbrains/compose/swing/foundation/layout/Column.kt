 ...
 * may report an extent outside that maximum. The height the column has left over is placed by
 * [verticalArrangement] - above the children, below them, between them, or as a fixed gap through
 * [Arrangement.spacedBy]. Across the column each child sits where [horizontalAlignment] puts it.
 *
