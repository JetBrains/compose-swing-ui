...
/**
 * One [Decorator] declaration. It is additive, so every declaration keeps its own slot and its own place among the
 * others rather than the last one winning, and they come apart in reverse.
 *
...
internal class DecoratorElement(
    ...
    /** One step of its component's decoration, painting the [decorator] its element declares. */
    class Node(
        ...
        ): Unit = decorator.paint(graphics, width, height, content)
    }
}
