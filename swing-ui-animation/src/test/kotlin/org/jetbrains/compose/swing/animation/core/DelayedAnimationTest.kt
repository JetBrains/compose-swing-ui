...
class DelayedAnimationTest {
    ...
    fun comparison() {
        ...
        assertEquals(delayed1, delayed2)
        assertNotEquals(delayed1, delayed3)
        assertNotEquals(delayed1, delayed4)

        assertEquals(delayed1.hashCode(), delayed2.hashCode())
        assertNotEquals(delayed1.hashCode(), delayed3.hashCode())
        assertNotEquals(delayed1.hashCode(), delayed4.hashCode())
    }
}
