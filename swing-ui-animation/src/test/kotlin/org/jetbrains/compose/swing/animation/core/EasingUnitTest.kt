...
class EasingUnitTest {
    ...
    fun canSolveCubicForSmallFractions() {
        ...
        for (i in testValues) {
            val t = curve.transform(Float.fromBits(i))
