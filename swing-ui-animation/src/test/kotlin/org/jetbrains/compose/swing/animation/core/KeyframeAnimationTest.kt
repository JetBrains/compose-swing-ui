...
class KeyframeAnimationTest {
    ...
    fun equalsStartAndEndValues() {
        ...
        assertEquals(start, animation.at(0))
        assertEquals(0.65f, animation.at(250))
        assertEquals(end, animation.at(fullTime.toLong()))
    }
    ...
    fun possibleToOverrideStartAndEndValues() {
        ...
        assertEquals(1f, animation.at(0))
        assertEquals(0f, animation.at(fullTime.toLong()))
    }
    ...
    fun withEasingOnFullDuration() {
        ...
        assertEquals(easing.transform(0.31f), animation.at(31))
    }
    ...
    fun easingOnTheSecondPart() {
        ...
        assertEquals(1f + easing.transform(0.4f), animation.at(140))
    }
    ...
    fun firstPartIsLinearWithEasingOnTheSecondPart() {
        ...
        assertEquals(0.25f, animation.at(25))
    }
    ...
    fun outOfRangeValuesOnly() {
        ...
        assertEquals(0f, animation.at(0))
        assertEquals(0f, animation.at(100))
        assertEquals(0f, animation.at(200))

        // Within time range
        assertEquals(0f, animation.at(delay))
        assertEquals(0.5f, animation.at((duration / 2) + delay))
        assertEquals(1f, animation.at(duration + delay))

        // Out of range - past animation duration
        // Should always be the target value unless it was overwritten
        assertEquals(1f, animation.at(delay + duration + 1))
        assertEquals(1f, animation.at(delay + duration + 50))
    }
    ...
    fun outOfRangeValues_withForcedInitialAndTarget() {
        ...
        // Within delay, should always return initial value unless it was overwritten
        assertEquals(4f, animation.at(0))
        assertEquals(4f, animation.at(100))
        assertEquals(4f, animation.at(200))

        // Within time range
        assertEquals(4f, animation.at(delay))
        assertEquals(4.5f, animation.at((duration / 2) + delay))
        assertEquals(5f, animation.at(duration + delay))

        // Out of range - past animation duration
        // Should always be the target value unless it was overwritten
        assertEquals(5f, animation.at(delay + duration + 1))
        assertEquals(5f, animation.at(delay + duration + 50))
    }
}
