...
import org.jetbrains.compose.swing.animation.core.AnimationEndReason.BoundReached
import org.jetbrains.compose.swing.animation.core.AnimationEndReason.Finished
...
): Animatable<Float, AnimationVector1D> = Animatable(initialValue, Float.VectorConverter, visibilityThreshold)
