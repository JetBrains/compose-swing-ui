...
throw reaching it ends the recomposer driving that content and tears down every content composition
standing on it. The throw is reported to the thread's uncaught-exception handler.
